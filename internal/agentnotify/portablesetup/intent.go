...
func intentMatches(intent Intent, pendingID, action, client, digest, treeDigest, helperDigest, helperVersion string) bool {
	...
	if helperVersion != "" && intent.HelperVersion != "" && helperVersion != intent.HelperVersion {
		return false
	}
