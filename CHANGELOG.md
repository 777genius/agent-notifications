...
- Relocate Claude hook ownership between sibling versioned plugin caches during updates while retaining any still-shared portable runtime. This unblocks the v1.45.7 to current-version upgrade without moving other consumers implicitly ([#228](https://github.com/777genius/agent-notifications/issues/228), [#236](https://github.com/777genius/agent-notifications/pull/236)).
