...
supported Claude/Codex user-scope metadata without creating state. Inspect and
Result expose per-client materialization/activation/authentication/verification.
